                ...
                tabBar: [
					{
						...
						"text": "首页",
						"imgNormal": "../../static/img/home-outline.png",
						"imgClick": "../../static/img/home.png"
					}, {
						"url": "/pages/DevicePage/index",
						"text": "设备",
						"imgNormal": "../../static/img/device-outline.png",
						"imgClick": "../../static/img/device.png"
					}, {
						"url": "/pages/AlarmPage/index",
						"text": "报警",
						"imgNormal": "../../static/img/alarm-outline.png",
						"imgClick": "../../static/img/alarm.png"
					}, {
						"url": "/pages/repairPage/index",
						"text": "报修",
						"imgNormal": "../../static/img/repair-outline.png",
						"imgClick": "../../static/img/repair.png"
					}, {
						"url": "/pages/minePage/index",
						"text": "我的",
						"imgNormal": "../../static/img/mine-outline.png",
						"imgClick": "../../static/img/mine.png"
					}
                ],
                level:''
