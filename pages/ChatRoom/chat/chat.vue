	...
	<view class="content">
		...
		<view class="input-box" :class="{ 'input-box-mpInputMargin': mpInputMargin }">
			<view class="input-box-flex">
				<image v-if="chatType === 'voice'" class="icon_img" :src="require('@/static/img/chat/voice.png')"  @click="switchChatType('keyboard')"></image>
				<image v-if="chatType === 'keyboard'" class="icon_img" :src="require('@/static/img/chat/keyboard.png')"  @click="switchChatType('voice')"></image>
				...
				<!-- 功能性按钮 -->
				<image class=" icon_btn_add" :src="require('@/static/img/chat/add.png')" @tap="switchFun"></image>
